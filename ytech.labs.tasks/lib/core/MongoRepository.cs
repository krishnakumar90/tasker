...
namespace ytech.labs.tasks.lib.core
{
    public class MongoRepository<TDocument> : IMongoRepository<TDocument> where TDocument : IDocument
    {
        private readonly IMongoCollection<TDocument> _collection;

        public MongoRepository(IMongoDbConfig dbConfig) : this(dbConfig.ConnectionString, dbConfig.Database)
        {
        ...
        {
            var database = new MongoClient(new MongoUrl(connectionString)).GetDatabase(databaseName);
